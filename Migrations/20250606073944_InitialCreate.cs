        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SpacesRequired = table.Column<int>(type: "int", nullable: false),
                    AllowedRows = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingReservations_ParkingSpaces_ParkingSpaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingReservations_ParkingSpaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSpaces_Row_Column",
                table: "ParkingSpaces",
